      ...
      <div className="container mx-auto px-4 text-primary">
        <div className="flex h-16 items-center justify-between">
          ...
          <Link href="/" className="flex items-center space-x-2">
            ...
            <Image src={'/mseal-logo.png'} alt="mseal logo" width={80} height={10} />
          </Link>
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <Link href="/sports" className="text-sm font-medium hover:text-accent transition-colors">
              Sports
            </Link>
            <Link href="/concerts" className="text-sm font-medium hover:text-accent transition-colors">
              Concerts
            </Link>
            <Link href="/theater" className="text-sm font-medium hover:text-accent transition-colors">
              Theater
            </Link>
          </nav>
          ...
          <div className="hidden lg:flex items-center space-x-4 flex-1 max-w-md mx-8">
            <div className="relative w-full">
              ...
              <Input placeholder="Search events, artists, teams..." className="pl-10 bg-secondary border-border" />
            </div>
          </div>
